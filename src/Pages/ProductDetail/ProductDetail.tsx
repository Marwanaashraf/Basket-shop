          ...
          <div className="contain my-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 my-8 p-3">
              ...
              <div className="flex flex-col space-y-3">
                ...
                {/* add to cart */}
                <button
                  disabled={product?.productDetails?.inStock === false}
                  className="btn"
                >
                  <svg
                    width="18"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-black">
                  {/* wishlist */}
                  <div className=" border border-gray-300 h-12 rounded-lg flex justify-center items-center space-x-2 font-semibold text-lg cursor-pointer hover:bg-gray-200 duration-500">
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
